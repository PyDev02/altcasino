...
In order to support loading of multiple wallets in ALTC-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ALTC.cpp.
...
Changes to ALTC.cpp
----------------------
ALTC.cpp is the entry point into ALTC-qt, and as such, will require some minor modifications to provide hooks for
