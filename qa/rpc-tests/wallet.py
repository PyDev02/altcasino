...
#   c) node1 mines 32 blocks, so now node 0 has 60001ALTC, node 1 has 4250ALTC, node2 has none.
#   d) node0 sends 601 ALTC to node2, in two transactions (301 ALTC, then 300 ALTC).
