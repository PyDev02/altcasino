...
RESOURCES += src/qt/ALTC.qrc src/qt/ALTC_locale.qrc

TRANSLATIONS += src/qt/locale/ALTC_bg.ts \
                src/qt/locale/ALTC_de.ts \
                src/qt/locale/ALTC_en.ts \
                src/qt/locale/ALTC_es.ts \
                src/qt/locale/ALTC_fi.ts \
                src/qt/locale/ALTC_fr.ts \
                src/qt/locale/ALTC_it.ts \
                src/qt/locale/ALTC_ja.ts \
                src/qt/locale/ALTC_pl.ts \
                src/qt/locale/ALTC_pt.ts \
                src/qt/locale/ALTC_ru.ts \
                src/qt/locale/ALTC_sk.ts \
                src/qt/locale/ALTC_sv.ts \
                src/qt/locale/ALTC_vi.ts \
                src/qt/locale/ALTC_zh_CN.ts \
                src/qt/locale/ALTC_zh_TW.ts
