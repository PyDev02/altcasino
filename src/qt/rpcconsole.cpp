                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzALTCPathCustom = GetArg("-zALTCbackuppath", "");
    ...
    if(!strzALTCPathCustom.empty()) {
        ui->wallet_customzALTCbackuppath->setText(QString::fromStdString(strzALTCPathCustom));
        ui->wallet_customzALTCbackuppath_label->setVisible(true);
        ui->wallet_customzALTCbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzALTCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ALTC RPC console.") + "<br>" +
