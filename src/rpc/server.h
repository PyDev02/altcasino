...
extern UniValue setzALTCseed(const UniValue& params, bool fHelp);
extern UniValue getzALTCseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzALTC(const UniValue& params, bool fHelp);
extern UniValue dzALTCstate(const UniValue& params, bool fHelp);
