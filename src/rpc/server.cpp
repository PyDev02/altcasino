...
static const CRPCCommand vRPCCommands[] =
{
        ...
        {"ALTC", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ALTC", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ALTC", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ALTC", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ALTC", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ALTC", "masternodedebug", &masternodedebug, true, true, false},
        {"ALTC", "startmasternode", &startmasternode, true, true, false},
        {"ALTC", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ALTC", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ALTC", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ALTC", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ALTC", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ALTC", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ALTC", "mnbudget", &mnbudget, true, true, false},
        {"ALTC", "preparebudget", &preparebudget, true, true, false},
        {"ALTC", "submitbudget", &submitbudget, true, true, false},
        {"ALTC", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ALTC", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ALTC", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ALTC", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ALTC", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ALTC", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ALTC", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ALTC", "checkbudgets", &checkbudgets, true, true, false},
        {"ALTC", "mnsync", &mnsync, true, true, false},
        {"ALTC", "spork", &spork, true, true, false},
        {"ALTC", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ALTC-cli " + methodname + " " + args + "\n";
}
