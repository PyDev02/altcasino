...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT5000IFMN = 3,
    ONLY_NONDENOMINATED_NOT5000IFMN = 4, // ONLY_NONDENOMINATED and not 5000 ALTC at the same time
...
public:
    ...
    string GetUniqueWalletBackupName(bool fzALTCAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzALTCTracker> zALTCTracker;
    ...
    {
        zwalletMain = zwallet;
        zALTCTracker = std::unique_ptr<CzALTCTracker>(new CzALTCTracker(strWalletFile));
    }

    CzALTCWallet* getZWallet() { return zwalletMain; }
