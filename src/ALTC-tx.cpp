...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ALTC Core ALTC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ALTC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ALTC transaction") + "\n" +
                               "  ALTC-tx [options] -create [commands]   " + _("Create hex-encoded ALTC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ALTC transaction
